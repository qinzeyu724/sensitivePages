...
for sentences in page:
    ...
    hs.get_sensitive_words_list_from_file(file='../assistingfile/new_words/1级.txt', grade=1)
    hs.get_sensitive_words_list_from_file(file='../assistingfile/new_words/2级.txt', grade=2)
    hs.get_sensitive_words_list_from_file(file='../assistingfile/new_words/3级.txt', grade=3)
...
for page,sensitive_words in zip(pages.page_list,sensitive_words):
    i += 1
    page = HandlePages.mark_sensitive_words(page.bs_page,sensitive_words,"../sensitive_pages/"+page.file_name)